...
public class RazasView {
    ...
    public RazasView(RazaController controller, Scanner input) {
...
//    ---------------------------------------------------------------1. AGREGAR RAZA--------------------------------------------------------------
    ...
    private void agregarRaza() {
        ...
        int especieId = Integer.parseInt(input.nextLine()); // 👈 convertir a int

        Razas raza = new Razas(nombre, especieId);
...
//    ---------------------------------------------------------------3. LISTAR POR ESPECIE--------------------------------------------------------------
    ...
    private void listarPorEspecie() {
        ...
        Integer especieId = input.nextInt();

        Razas raza = (Razas) controller.listarPorEspecie(especieId);
        if (raza != null) {
...
//    ---------------------------------------------------------------5. ACTUALIZAR RAZA--------------------------------------------------------------
    ...
    private void actualizarRaza() {
        ...
        System.out.print("Ingrese el nuevo ID de la especie: ");
        int especieId = Integer.parseInt(input.nextLine());

        Razas raza = new Razas(nombre, especieId);

        controller.actualizarRaza(raza);
